...
export const Answer = ({ answer, onCitationClicked, onExectResultClicked }: Props) => {
  ...
  const UnhelpfulFeedbackContent = () => {
    return (
      <>
        <div>Pourquoi cette réponse n'a-t-elle pas été utile ?</div>
        <Stack tokens={{ childrenGap: 4 }}>
          <Checkbox
            label="Les citations sont manquantes"
  ...
  const ReportInappropriateFeedbackContent = () => {
    return (
      <>
        ...
        <Stack tokens={{ childrenGap: 4 }}>
          <Checkbox
            label="Discours de haine, stéréotypes, humiliations"
          ...
          <Checkbox
            ...
            onChange={updateFeedbackList}></Checkbox>
          <Checkbox
            label="Sexuel : contenu explicite, grooming"
            id={Feedback.Sexual}
            defaultChecked={negativeFeedbackList.includes(Feedback.Sexual)}
            onChange={updateFeedbackList}></Checkbox>
          <Checkbox
            label="Manipulateur : sournois, émotif, autoritaire, intimidant"
              ...
              <Stack style={{ width: '100%' }}>
                <Stack horizontal horizontalAlign="start" verticalAlign="center">
                  <Text
                    ...
                    aria-label="Références ouvertes"
                    tabIndex={0}
                    role="button">
                    <span>
