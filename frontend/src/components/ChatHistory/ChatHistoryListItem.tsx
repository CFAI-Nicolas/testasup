...
export const ChatHistoryListItemCell: React.FC<ChatHistoryListItemCellProps> = ({ item, onSelect }) => {
  ...
  const dialogContentProps = {
    ...
    subText: 'L historique de cette session de chat sera définitivement supprimé.'
  }
    ...
    <Stack
      ...
      {errorDelete && (
        <Text
          ...
          Erreur : impossible de supprimer l'élément
        </Text>
      )}
      <Dialog
    ...
    <div className={styles.listContainer} data-is-scrollable>
      ...
      {showSpinner && (
        <div className={styles.spinnerContainer}>
          <Spinner size={SpinnerSize.small} aria-label="chargement de plus d'historique de discussion" className={styles.spinner} />
        </div>
      )}
    </div>
  )
