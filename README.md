...
| App Setting | Required? | Default Value | Note |
|---|---|---|---|
|UI_TITLE|No|Groupe Schmidt| Chat title (left-top) and page title (HTML)
|UI_LOGO|No|| Logo (left-top). Defaults to Groupe Schmidt logo. Configure the URL to your logo image to modify.
|UI_CHAT_LOGO|No|| Logo (chat window). Defaults to Groupe Schmidt logo. Configure the URL to your logo image to modify.
...
|UI_FAVICON|No|| Defaults to Groupe Schmidt favicon. Configure the URL to your favicon to modify.
